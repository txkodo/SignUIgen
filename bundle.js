...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var style = document.createElement(\"style\");\n  options.setAttributes(style, options.attributes);\n  options.insert(style);\n  return style;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://signuigenerator/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(style) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    style.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://signuigenerator/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, style) {\n  if (style.styleSheet) {\n    style.styleSheet.cssText = css;\n  } else {\n    while (style.firstChild) {\n      style.removeChild(style.firstChild);\n    }\n\n    style.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://signuigenerator/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.AreaManager = exports.AreaList = exports.AreaSetting = exports.AreaInput = exports.AreaItem = void 0;\r\nvar Button = /** @class */ (function () {\r\n    function Button(content, onClick) {\r\n        this.element = document.createElement('button');\r\n        this.element.appendChild(content);\r\n        this.element.addEventListener('click', onClick);\r\n    }\r\n    return Button;\r\n}());\r\nvar AreaItem = /** @class */ (function () {\r\n    function AreaItem(areaManager) {\r\n        this.element = this.createItem();\r\n        this.areaManager = areaManager;\r\n        this.active = false;\r\n        this.area = { name: 'area', x: { start: 0, end: 0 }, y: { start: 0, end: 0 }, command: '' };\r\n    }\r\n    AreaItem.prototype.createItem = function () {\r\n        var _this = this;\r\n        var li = document.createElement('li');\r\n        li.classList.add('dp2');\r\n        var span = document.createElement('span');\r\n        span.textContent = 'area';\r\n        li.appendChild(span);\r\n        li.appendChild(this.createDelButton().element);\r\n        li.onclick = function () { return _this.activate(); };\r\n        return li;\r\n    };\r\n    AreaItem.prototype.createDelButton = function () {\r\n        var icon = document.createElement('span');\r\n        icon.classList.add('far', 'fa-trash-alt', 'icon');\r\n        var button = new Button(icon, AreaItem.delete(this));\r\n        return button;\r\n    };\r\n    AreaItem.prototype.setValue = function (area) {\r\n        this.area = area;\r\n        if (this.element.firstChild) {\r\n            this.element.firstChild.textContent = area.name;\r\n        }\r\n    };\r\n    AreaItem.prototype.getValue = function () {\r\n        return this.area;\r\n    };\r\n    AreaItem.prototype.activate = function () {\r\n        this.areaManager.areaList.disactivateAll();\r\n        this.areaManager.areaSetting.apply(this);\r\n        this.active = true;\r\n        this.element.classList.add('active');\r\n    };\r\n    AreaItem.prototype.disactivate = function () {\r\n        this.active = false;\r\n        this.element.classList.remove('active');\r\n    };\r\n    AreaItem.delete = function (self) {\r\n        return function () {\r\n            self.element.onclick = function () { };\r\n            if (self.active) {\r\n                self.areaManager.areaSetting.disapply();\r\n            }\r\n            self.areaManager.areaList.remove(self);\r\n        };\r\n    };\r\n    return AreaItem;\r\n}());\r\nexports.AreaItem = AreaItem;\r\nvar AreaInput = /** @class */ (function () {\r\n    function AreaInput(name, x0, x1, y0, y1, command) {\r\n        this.name = name;\r\n        this.x0 = x0;\r\n        this.x1 = x1;\r\n        this.y0 = y0;\r\n        this.y1 = y1;\r\n        this.command = command;\r\n    }\r\n    AreaInput.prototype.setValue = function (area) {\r\n        this.name.value = area.name;\r\n        this.x0.value = \"\" + area.x.start;\r\n        this.x1.value = \"\" + area.x.end;\r\n        this.y0.value = \"\" + area.y.start;\r\n        this.y1.value = \"\" + area.y.end;\r\n        this.command.value = area.command;\r\n    };\r\n    AreaInput.prototype.writable = function () {\r\n        this.name.readOnly = false;\r\n        this.x0.readOnly = false;\r\n        this.x1.readOnly = false;\r\n        this.y0.readOnly = false;\r\n        this.y1.readOnly = false;\r\n        this.command.readOnly = false;\r\n    };\r\n    AreaInput.prototype.readonly = function () {\r\n        this.name.readOnly = true;\r\n        this.x0.readOnly = true;\r\n        this.x1.readOnly = true;\r\n        this.y0.readOnly = true;\r\n        this.y1.readOnly = true;\r\n        this.command.readOnly = true;\r\n    };\r\n    return AreaInput;\r\n}());\r\nexports.AreaInput = AreaInput;\r\nvar AreaSetting = /** @class */ (function () {\r\n    function AreaSetting(areaInput) {\r\n        var _this = this;\r\n        this.area = {\r\n            name: '',\r\n            x: { start: 0, end: 0 },\r\n            y: { start: 0, end: 0 },\r\n            command: ''\r\n        };\r\n        this.areaInput = areaInput;\r\n        this.areaInput.name.addEventListener('change', function () { _this.area.name = _this.areaInput.name.value; _this.onChange(); });\r\n        this.areaInput.command.addEventListener('change', function () { _this.area.command = _this.areaInput.command.value; _this.onChange(); });\r\n        this.areaInput.x0.addEventListener('change', function () { _this.area.x.start = parseFloat(_this.areaInput.x0.value); _this.onChange(); });\r\n        this.areaInput.x1.addEventListener('change', function () { _this.area.x.end = parseFloat(_this.areaInput.x1.value); _this.onChange(); });\r\n        this.areaInput.y0.addEventListener('change', function () { _this.area.y.start = parseFloat(_this.areaInput.y0.value); _this.onChange(); });\r\n        this.areaInput.y1.addEventListener('change', function () { _this.area.y.end = parseFloat(_this.areaInput.y1.value); _this.onChange(); });\r\n        this.areaItem = null;\r\n        this.disapply();\r\n    }\r\n    AreaSetting.prototype.apply = function (areaItem) {\r\n        this.areaItem = areaItem;\r\n        this.area = areaItem.getValue();\r\n        this.reflesh();\r\n        this.areaInput.writable();\r\n    };\r\n    AreaSetting.prototype.disapply = function () {\r\n        this.areaItem = null;\r\n        this.area = {\r\n            name: '',\r\n            x: { start: 0, end: 0 },\r\n            y: { start: 0, end: 0 },\r\n            command: ''\r\n        };\r\n        this.reflesh();\r\n        this.areaInput.readonly();\r\n    };\r\n    AreaSetting.prototype.reflesh = function () {\r\n        this.areaInput.setValue(this.area);\r\n    };\r\n    AreaSetting.prototype.onChange = function () {\r\n        if (this.areaItem) {\r\n            this.areaItem.setValue(this.area);\r\n        }\r\n    };\r\n    return AreaSetting;\r\n}());\r\nexports.AreaSetting = AreaSetting;\r\nvar AreaList = /** @class */ (function () {\r\n    function AreaList(ul) {\r\n        this.list = [];\r\n        this.element = ul;\r\n    }\r\n    AreaList.prototype.disactivateAll = function () {\r\n        for (var _i = 0, _a = this.list; _i < _a.length; _i++) {\r\n            var item = _a[_i];\r\n            item.disactivate();\r\n        }\r\n    };\r\n    AreaList.prototype.append = function (li) {\r\n        this.list.push(li);\r\n        this.element.appendChild(li.element);\r\n    };\r\n    AreaList.prototype.remove = function (li) {\r\n        this.list = this.list.filter(function (item) { return item !== li; });\r\n        this.element.removeChild(li.element);\r\n    };\r\n    return AreaList;\r\n}());\r\nexports.AreaList = AreaList;\r\nvar AreaManager = /** @class */ (function () {\r\n    function AreaManager(listElement, addButton, areaInput) {\r\n        var _this = this;\r\n        this.areaList = new AreaList(listElement);\r\n        this.areaSetting = new AreaSetting(areaInput);\r\n        addButton.addEventListener('click', function () {\r\n            var li = new AreaItem(_this);\r\n            _this.areaList.append(li);\r\n        });\r\n    }\r\n    return AreaManager;\r\n}());\r\nexports.AreaManager = AreaManager;\r\n\n\n//# sourceURL=webpack://signuigenerator/./src/ts/area_list.ts?");
